...
const GlowingEffect = memo(
  ({
    ...
    inactiveZone = 0.7,
    proximity = 0,
    spread = 40, // Increased default spread for stronger visibility
    variant = "default",
    glow = true, // Default to true so it shows up
    className,
    movementDuration = 2,
    borderWidth = 2, // Slightly thicker border for better color presence
          ...
          style={
            {
              ...
              "--gradient":
                variant === "white"
                  ...
                  : `radial-gradient(circle, #dd7bbb 20%, transparent 80%),
                     radial-gradient(circle at 40% 40%, #d79f1e 15%, transparent 70%),
                     radial-gradient(circle at 60% 60%, #5a922c 20%, transparent 80%), 
                     radial-gradient(circle at 40% 60%, #4c7894 20%, transparent 80%),
        ...
        >
          <div
            className={cn(
              ...
              // IMPROVED MASK: This allows more of the color gradient to show through
